...
function you_title_stylesheets() {
...
add_action('wp_enqueue_scripts', 'you_title_stylesheets');
// for footer
function you_title_stylesheets_footer() {
...
add_action('get_footer', 'you_title_stylesheets_footer');
...
add_action('after_setup_theme', 'you_title_menus');
